...
\input{fig_ods_table.tex}

A continuación se justifica el grado de relación asignado a los ODS con mayor vinculación con el trabajo.

\textbf{ODS 4 — Educación de Calidad (Medio).} El trabajo tiene un carácter formativo puesto que aborda el estudio e implementación desde cero de protocolos de comunicación industrial (CAN, ISO-TP, OBD-II) sobre hardware de bajo coste y accesible. El banco de pruebas basado en Arduino, junto con la documentación del proceso de desarrollo, constituyen un recurso didáctico reutilizable para la enseñanza de sistemas empotrados, protocolos de comunicación y arquitectura software en capas en titulaciones de ingeniería informática y electrónica.

\textbf{ODS 9 — Industria, Innovación e Infraestructuras (Medio).} La implementación directa de la pila de protocolos OBD-II sobre hardware de propósito general, sin depender de firmware propietario como el ELM327, representa una aproximación innovadora al diagnóstico del vehículo de bajo coste. Este tipo de soluciones puede favorecer el acceso a capacidades de diagnóstico en entornos donde las herramientas profesionales resultan económicamente inaccesibles.
