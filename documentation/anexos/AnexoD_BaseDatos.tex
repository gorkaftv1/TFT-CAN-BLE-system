\chapter*{Anexo D — Esquema de la base de datos SQLite}
\addcontentsline{toc}{chapter}{Anexo D — Esquema de la base de datos SQLite}
\label{anexo:bbdd}

La base de datos SQLite empleada para la persistencia de datos de diagnóstico se
compone de tres tablas relacionadas. El esquema completo, incluyendo los índices
...
CREATE TABLE IF NOT EXISTS commands (
    id           INTEGER PRIMARY KEY AUTOINCREMENT,
    session_id   INTEGER NOT NULL REFERENCES sessions(id),
    command      TEXT    NOT NULL,   -- nombre del comando (query, dtcs, vin...)
