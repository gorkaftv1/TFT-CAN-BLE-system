...
\textbf{Acceso inalámbrico mediante BLE GATT con logging persistente.} La integración de un servidor BLE GATT sobre Raspberry Pi, combinada con el registro estructurado de datos en SQLite, permite el acceso en tiempo real a los parámetros del vehículo, asi como la consulta posterior de sesiones históricas completas, incluyendo las tramas CAN en hexadecimal correspondientes a cada comando ejecutado.
