...
\centering
\includegraphics[width=\linewidth]{Ilustraciones/cuadro_konwei.png}
\subcaption{Cuadro de instrumentos (lectura de PIDs).}
\label{fig:ref_panel}
\end{minipage}\hfill
\begin{minipage}[t]{0.42\textwidth}
\centering
\includegraphics[width=\linewidth]{Ilustraciones/dtc_konwei.PNG}
...
\centering
\includegraphics[width=\linewidth]{Ilustraciones/iter_2_ard.png}
\subcaption{Consola del simulador Arduino.}
\label{fig:res_consola_ard}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{Ilustraciones/iter_2_pi.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\linewidth]{Ilustraciones/datos_real.png}
\hfill
\includegraphics[width=0.48\linewidth]{Ilustraciones/uds_real.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\linewidth]{Ilustraciones/dtcs_real.png}
\hfill
\includegraphics[width=0.48\linewidth]{Ilustraciones/sesiones_sim.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\linewidth]{Ilustraciones/sesion_detalle.png}
\hfill
\includegraphics[width=0.48\linewidth]{Ilustraciones/logs_real.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\linewidth]{Ilustraciones/conexion.png}
\hfill
\includegraphics[width=0.48\linewidth]{Ilustraciones/ajustes.png}
