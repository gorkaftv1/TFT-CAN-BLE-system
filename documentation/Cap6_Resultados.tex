...
\hline
1 & Pila ISO-TP + OBD-II modos 0x01/03/04/09 operativa & Completo \\
2 & Simulador Arduino responde a los 4 modos con datos realistas & Completo \\
3 & Ruido CAN: descarte, NRC, latencia, tráfico de fondo & Completo \\
4 & Servidor BLE GATT con NUS operativo en Raspberry Pi & Completo \\
5 & App React Native Android/iOS con 5 pantallas funcionales & Completo \\
6 & Logging SQLite con sesiones, muestras y comandos & Completo \\
\hline
\end{tabular}
\end{table}
