...
La herramienta se encarga tanto de codificar peticiones como de decodificar los parámetros recibidos, almacenándolos en una base de datos SQLite y a su vez transmitiéndolos inalámbricamente usando Bluetooth Low Energy (BLE) mediante un servidor GATT que se encuentra montado en la propia Raspberry Pi que implementa el servicio Nordic UART Service (NUS).
...
Actualmente los automóviles integran numerosos microcontroladores que generan datos de telemetría y además cuentan con el protocolo de diagnóstico OBD-II. Estos son accesibles a través del puerto OBD que se encuentra normalmente en la parte inferior del volante en el asiento del piloto. Este puerto permite que no solo los talleres y personas especializadas en el mundo de la mecánica y electromecánica, sino que cualquier persona con un "escáner" pueda ver el estado de su coche o pueda diagnosticar qué fallo tiene o anticipar posibles fallos.

En el mercado existen numerosas soluciones para el acceso al diagnóstico OBD-II~\cite{CSSElec_OBD2}, en su mayoría basadas en el adaptador ELM327 junto con aplicaciones como Torque Pro u OBD Fusion. Más que recurrir a una de ellas, este trabajo aborda la construcción del sistema desde cero —implementando los protocolos de aplicación OBD-II y UDS sobre la capa de transporte ISO-TP, con un fin principalmente formativo y de comprensión profunda de los protocolos de comunicación del vehículo.
